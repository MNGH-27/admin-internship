...
export const configCompanySchema = yup.object().shape({
   ...
   company_postal_code: yup
      ...
      .default(''),
   company_category: yup.string().required('مقدار نوع شرکت الزامی است').default(''),
   company_type: yup.string().required('مقدار نوع شرکت الزامی است').default(''),
   company_address: yup.string().required('مقدار آدرس شرکت الزامی است').default(''),
   ...
   last_name: yup.string().required('مقدار نام خانوادگی سرپرست الزامی است').default(''),
   email: yup.string().email('ایمیل را به درستی وارد کنید').required('مقدار ایمیل سرپرست الزامی است').default(''),
   national_code: yup
      .string()
      ...
      .default(''),
   username: yup.string().required('مقدار نام کاربری سرپرست الزامی است').default(''),
   phone_number: yup
      .string()
