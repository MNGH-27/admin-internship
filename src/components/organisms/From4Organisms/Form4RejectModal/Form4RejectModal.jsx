...
const Form4RejectModal = ({ isShow, onClose, id, formStage, status, rejection_reason }) => {
   ...
   const { mutate, isLoading: isRejectingStudent } = useMutation({
      ...
      onSuccess: () => {
         toast.success('رد فرم چهار دانشجو با موفقیت انجام شد')
      ...
      onError: () => {
         toast.error('رد فرم شماره چهار دانشجو ناموفق بود')
      },
   })
   ...
   return (
      <Modal isShow={isShow} onClose={onClose}>
         ...
         >
            ...
            <span className="text-[#5F5F61] text-xs">ایا از رد فرم چهار دانشجو اطمینان دارید ؟</span>
...
export default Form4RejectModal
