...
const FormFinishInternshipRejectModal = ({ isShow, onClose, id, formStage, status, rejection_reason }) => {
   ...
   const { mutate, isLoading: isRejectingStudent } = useMutation({
      ...
      onError: () => {
         toast.error('رد فرم پایان کارآموزی دانشجو ناموفق بود')
      },
   })
...
export default FormFinishInternshipRejectModal
