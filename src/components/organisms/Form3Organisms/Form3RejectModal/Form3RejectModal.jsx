...
const Form3RejectModal = ({ isShow, onClose, id, formStage, status, rejection_reason }) => {
   ...
   const { mutate, isLoading: isRejectingStudent } = useMutation({
      ...
      onError: () => {
         toast.error('رد فرم شماره سه دانشجو ناموفق بود')
      },
   })
   ...
   return (
      <Modal isShow={isShow} onClose={onClose}>
         ...
         >
            ...
            <span className="text-[#5F5F61] text-xs">ایا از رد فرم سه دانشجو اطمینان دارید ؟</span>
...
export default Form3RejectModal
